  ...
  return (
    <div className="flex flex-col justify-center items-center relative w-full h-full text-center px-10 md:px-[10vw] pt-[15vh] md:pt-[15vh] ">
      ...
      <div className="space-y-2 md:space-y-8">
        ...
        <p data-aos="fade-right" className="mx-auto w-3/4 tracking-wide leading-snug text-white text-center lg:text-justify text-sm sm:text-lg md:text-xl lg:text-2xl font-thai ">
          วิศวะคอมบางมดเรียนเกี่ยวกับอะไร ? วิศวะคอมบางมดจบไปแล้วทำอะไร ? วิศวะคอมบางมดเรียนสนุกไหม ?
          ยินดีต้อนรับน้อง ๆ เข้าสู่โครงการฝึกอบรมเชิงปฏิบัติการคอมพิวเตอร์ ครั้งที่ 33 หรือ Comcamp#33 ค่ายออนไลน์ที่เปิดโอกาสให้น้อง ๆ เข้ามาสัมผัสประสบการณ์ภายในภาควิชาวิศวกรรมคอมพิวเตอร์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี ผ่านการเรียนเนื้อหาจริง ทำผลงานจริง และประสบการณ์จริงสุดเอ็กซ์คลูซีฟจากพี่ ๆ วิศวะคอม ไปพร้อมกับเพื่อน ๆ ทั้ง 100 คน !! และที่สำคัญ ค่ายนี้ ฟรีตลอดค่าย !! รีบสมัครเข้ามาเป็นส่วนหนึ่งของค่ายกันเยอะ ๆ น้าาาาา 💖

        </p>
        <div data-aos="fade-right" className="text-sm sm:text-lg md:text-xl lg:text-2xl mx-auto w-3/4 text-white flex flex-col lg:flex-row  justify-start relative">
