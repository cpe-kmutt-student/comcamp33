...
const First = () => {
    ...
    return (
        <>
            <div className="absolute h-screen w-screen right-0 top-5 ">
                {/* <Image src="/assets/first/radiant.svg" quality={100} layout="fill" objectFit="cover" alt="light" /> */}
                <svg className='h-screen w-screen' viewBox="0 0 1855 1080" xmlns="http://www.w3.org/2000/svg" objectFit="cover" layout="fill">
