  ...
  return (
    <>
      ...
      <div className="font-pixel w-full flex justify-center relative text-white top-0 text-center z-[90] text-xl mb-4 tracking-widest hover:brightness-110 ">
        ...
        >
          <div className="cursor-pointer w-5/4 font-pixel relative text-white top-0 text-center  bg-gradient-to-b from-[#F054F3] to-[#9600FF] px-6 py-2  border-2 text-4xl border-3 border-[#B3E7F8] hover:shadow-[0_0px_15px_-2px_rgba(150,0,255,1)] hover:shadow-[#9600FF] transition-all duration-300 ease-linear rounded-xl  animate-float   tracking-widest ">
            register Now
          </div>
        </button>
      </div>
