    ...
    <div className="mx-10 lg:mx-4">
        ...
        <div className="grid gridrows-3 lg:grid-cols-3 gap-6">
            <div className="flex flex-col justify-center"><Image src="/assets/condition/Studying.svg"
              ...
              />
              <div className="text-base font-thai text-white md:text-2xl py-4  lg:py-4 my-6 px-10 bg-[#04B1AF]">
...
ผู้ที่ยืนยันสิทธ์กับทาง ภาควิศวกรรมคอมพิวเตอร์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี
            ...
            <Image src="/assets/condition/Parent.svg"
              ...
              />
               <div className="text-base font-thai text-white py-2 md:text-2xl md:py-16 my-6 px-10 bg-[#556CC9]">
               มีความสนใจในด้านคอมพิวเตอร์
โดยไม่จำเป็นต้องมีพื้นฐานมาก่อน

              </div>
            </div>
            <div className="flex flex-col text-white justify-center"><Image src="/assets/condition/piccom.svg"
              width={460}
              height={540}
              quality={100}
              
              />
              <div className="text-base font-thai py-4 md:text-2xl md:py-16 my-6 px-10 bg-[#DD517E]">
